...
class TestEvent(TestCase):
    ...
    def test_parse(self):
        params1 = {
            "options": {},
            "data": {
                "evalMatches": [{"metric": "Count", "tags": {}, "value": 24.0}],
                "orgId": 1.0,
        ...
        params5 = {
            ...
            "data": {
                "evalMatches": [
                    {"tags": {}, "value": 0.020317392596204395, "metric": "{}"}
                ],
                "ruleId": 92.0,
                "ruleName": "Kubelet Runtime Operations Error Rate alert",
                "tags": {},
        ...
        params6 = {
            ...
            "data": {
                ...
                "evalMatches": [
                    {
                        "tags": {"code": "0", "verb": "WATCH"},
                        "metric": "0 WATCH",
                        "value": 0.7647628374624433,
                    },
                    {
                        "tags": {"verb": "POST", "code": "201"},
                        "metric": "201 POST",
        ...
        params9 = {
            ...
            "data": {
                ...
                "evalMatches": [{"tags": {}, "metric": "Count", "value": 1.0}],
